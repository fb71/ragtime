...
public class OAIImageLab
    ...
    public static final String KEY_BUILD = "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";
    public static final String KEY_DEV = "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";
